...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: viewbiodatasiswa9B.php");
}

// Ambil data lama untuk ditampilkan di form
$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM biodata9b WHERE id=$id"));
?>
...
<form method="POST">
    <h2>Edit Biodata Siswa Kelas 9B</h2>
