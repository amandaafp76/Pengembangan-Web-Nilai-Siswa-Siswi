...
<body class="biodatasiswa-page">
    ...
    <div class="container">
        <h2>DAFTAR NILAI KELAS 8A</h2>

        <!-- Tombol Tambah -->
        <div style="margin-bottom: 20px;">
            <a href="tambahnilai8A.php" style="background-color:#003366; color:white; padding:10px 15px; border-radius:5px; text-decoration:none;">➕ Tambah Data</a>
        </div>
        ...
        <table class="tabel-siswa" border="1" cellpadding="10" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php
                $no = 1;
                $result = mysqli_query($conn, "SELECT * FROM nilai8a ORDER BY id DESC");
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                                <a href='editnilai8A.php?id=" . $row['id'] . "'>✏ Edit</a> |
                                <a href='hapusnilai8A.php?id=" . $row['id'] . "' onclick=\"return confirm('Yakin ingin hapus?')\">🗑 Hapus</a>
                              </td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='9' style='text-align:center;'>Belum ada data nilai untuk kelas 8A.</td></tr>";
                }
                ?>
            </tbody>
        </table>
