...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: viewbiodatasiswa8A.php");
}

// Ambil data lama untuk ditampilkan di form
$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM biodata8A WHERE id=$id"));
?>
...
<form method="POST">
    <h2>Edit Biodata Siswa Kelas 8A</h2>
