...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE nilai8a SET nisn='$nisn', nama='$nama', kelas='$kelas',
              ganjil=$ganjil, genap=$genap, rata_rata=$rata, predikat='$predikat'
              WHERE id=$id";
    mysqli_query($conn, $query);
    header("Location: viewnilaisiswa8A.php");
}

$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM nilai8a WHERE id=$id"));
?>
