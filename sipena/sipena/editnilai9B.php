...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE nilai9b SET nisn='$nisn', nama='$nama', kelas='$kelas',
              ganjil=$ganjil, genap=$genap, rata_rata=$rata, predikat='$predikat'
              WHERE id=$id";
    mysqli_query($conn, $query);
    header("Location: viewnilaisiswa9B.php");
}

$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM nilai9b WHERE id=$id"));
?>
