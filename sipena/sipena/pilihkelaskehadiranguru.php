...
<body class="pilihkelas-page">
    ...
    <div class="kelas-container">
        ...
        <select class="select-kelas" onchange="window.location.href=this.value">
            ...
            <option value="kehadiranGuru.php">Kelas 7A</option>
            <option value="kehadiranGuru.php">Kelas 7B</option>
            <option value="kehadiranGuru.php">Kelas 8A</option>
            <option value="kehadiranGuru.php">Kelas 8B</option>
            <option value="kehadiranGuru.php">Kelas 9A</option>
            <option value="kehadiranGuru.php">Kelas 9B</option>
        </select>
    </div>
