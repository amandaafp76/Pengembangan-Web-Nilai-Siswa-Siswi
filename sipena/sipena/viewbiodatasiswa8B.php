...
<body class="biodatasiswa-page">
    ...
    <div class="container">
        <h2>BIODATA SISWA KELAS 8B</h2>

        <!-- Tombol Tambah -->
        <div style="margin-bottom: 20px;">
            <a href="tambahbiodata8B.php" style="background-color:#003366; color:white; padding:10px 15px; border-radius:5px; text-decoration:none;">➕ Tambah Biodata</a> 
        </div>
        ...
        <table class="tabel-siswa" border="1" cellpadding="10" cellspacing="0" width="100%">
            ...
            <tbody>
                <?php
                $no = 1;
                $result = mysqli_query($conn, "SELECT * FROM biodata8b ORDER BY id DESC");
                ...
                if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo "<td>
                                <a href='editbiodata8B.php?id=" . $row['id'] . "'>✏ Edit</a> | 
                                <a href='hapusbiodata8B.php?id=" . $row['id'] . "' onclick=\"return confirm('Yakin ingin hapus?')\">🗑 Hapus</a> 
                              </td>";
                        echo "</tr>";
                    }
                } else {
                    echo "<tr><td colspan='10' style='text-align:center;'>Belum ada data biodata siswa untuk kelas 8B.</td></tr>";
                }
                ?>
            </tbody>
        </table>
