...
<body class="pilihkelas-page">
    ...
    <div class="kelas-container">
        ...
        <select class="select-kelas" onchange="window.location.href=this.value">
            ...
            <option value="viewbiodatasiswa7A.php">Kelas 7A</option>
            <option value="viewbiodatasiswa7B.php">Kelas 7B</option>
            <option value="viewbiodatasiswa8A.php">Kelas 8A</option>
            <option value="viewbiodatasiswa8B.php">Kelas 8B</option>
            <option value="viewbiodatasiswa9A.php">Kelas 9A</option>
            <option value="viewbiodatasiswa9B.php">Kelas 9B</option>
        </select>
    </div>
