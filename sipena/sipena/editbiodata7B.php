...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    header("Location: viewbiodatasiswa7B.php");
}

// Ambil data lama untuk ditampilkan di form
$data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM biodata7b WHERE id=$id"));
?>
...
<form method="POST">
    <h2>Edit Biodata Siswa Kelas 7B</h2>
